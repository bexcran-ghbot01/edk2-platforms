...
STATIC CONST EFI_GUID mJadeAcpiTableAc01File = { 0x5addbc13, 0x8634, 0x480c, { 0x9b, 0x94, 0x67, 0x1b, 0x78, 0x55, 0xcd, 0xb8 } };
  ...
  )
{
  ...
  if (IsAc01Processor ()) {
    Status = LocateAndInstallAcpiFromFv (&mJadeAcpiTableAc01File);
  } else {
